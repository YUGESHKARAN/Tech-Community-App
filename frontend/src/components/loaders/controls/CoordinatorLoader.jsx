...
const CoordinatorLoader = ({roleFilter}) => {
  return (
    // <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-full px-4 mx-auto mt-2 animate-pulse">
    ...
    //         <div className="h-8 w-28 bg-gray-800 rounded-md" />
...
export default CoordinatorLoader;
