...
function AddPost() {
  ...
  const [messages, setMessages] = useState([
    ...
    {
      message:
        "Your enhanced content will automatically appear in the Description tab, where you can preview and edit further...",
      sender: "bot",
      direction: "incoming",
    },
  ]);
    ...
    <div className="min-h-screen relative theme text-white">
      ...
      <div className="min-h-screen  max-w-[1800px] mx-auto  w-full pt-4 pb-8">
        <div className="w-full  mx-auto  md:px-12">
          <div className=" mb-6 flex px-4 items-center justify-between">
            <div>
