        ...
        {posts.length > 0 && (
              ...
              >
                <div
                  ...
                  className="flex w-full px-3  md:w-fit md:max-w-7xl   py-3 md:my-2 z-50 scrollbar-hide mx-auto items-center justify-start gap-3 overflow-x-auto"
                >
                  {/* All Button */}
                  <div
                ...
                <div className="flex items-center gap-3 px-4 py-2 md:py-3">
                  <Link to={`/viewProfile/${data.authorEmail}`}>
                    <img
                      ...
                      className=" w-7 h-7 rounded-full bg-white object-cover border border-gray-700"
                      alt={data.authorName}
                    />
                  </Link>
