...
const rollbackDeletion = async (req, res) => {
  try {
    ...
    const recoveryMessage = `
      ...
      Your account has been successfully recovered. Your account was deleted on **${deletedAt}** and has now been fully restored. All your previous data — posts, followers, communities, and personal links — are restored.
