...
const initials = (name) => name?.slice(0, 2).toUpperCase() ?? "??";
  ...
  return (
    <div className="w-full min-h-screen theme relative">
      <NavBar />
      <div className="mb-6 mt-4 px-4 md:px-12 mx-auto flex items-center justify-between">
        <div>
          <h1 className="md:text-xl text-xl font-semibold   text-white tracking-tight">
            Update Playlist
          </h1>
          ...
          <div className="p-2 md:p-6 space-y-7 pt-0 shadow-lg">
            ...
            <div className="lg:col-span-3 hidden md:block flex justify-start pt-0">
              ...
              >
                ...
                <motion.span
                  key={loader ? "Updating Playlist..." : "Update Playlist"}
