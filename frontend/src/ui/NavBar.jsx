...
>
  ...
  <div className="flex items-center gap-3 md:gap-4">
     <Link
        ...
        >
          <MdAnnouncement className="text-xl text-gray-300 hover:text-white cursor-pointer transition" />
          {announceCount > 0 && (
    ...
    <div className="relative hidden md:block">
      <IoMdNotifications
        ...
        className="text-xl  text-gray-300 hover:text-white cursor-pointer transition"
      />
      {notiCount > 0 && (
    ...
    <div className="flex md:hidden items-center gap-3 px-3 py-1.5
                 bg-white/5 
                 border border-white/10
