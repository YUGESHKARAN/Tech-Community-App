    ...
    <div className="w-full xl:w-11/12 mx-auto px-3 md:px-4 md:px-8 pt-3 pb-20 md:pt-4 md:pb-10 animate-pulse">
      ...
      <div className="grid grid-cols-1 mt-2 md:mt-0 md:grid-cols-6 md:gap-8 gap-4 md:gap-6">
        ...
        <div className="md:col-span-4 space-y-4 md:space-y-6">
          {/* Banner */}
          <div className="h-56 md:h-[360px] bg-gray-800 rounded-xl border border-gray-700" />
          ...
          <div className="flex items-center  justify-between md:justify-end mt-2 gap-4 my-3 md:mb-5">
            ...
            <div className="flex items-center gap-4 md:gap-3">
              <button className=" bottom-4 flex items-center gap-2 bg-gray-700 w-28  md:w-16 h-6  right-4 bg text-black text-sm px-5 py-2 rounded-full animate-pulse  shadow-xl"></button>
