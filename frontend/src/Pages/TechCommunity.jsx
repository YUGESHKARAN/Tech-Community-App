                ...
                >
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div>
                        <h2 className="text-base md:text-xl font-bold bg-gradient-to-r from-green-400 via-blue-400 to-pink-400 bg-clip-text text-transparent drop-shadow-lg truncate  tracking-tight">
                          {item.categoryname}
                        </h2>
                        <p className="text-[11px] text-gray-400 md:text-gray-300 mt-0.5">
                          Tech Domain
                        </p>
                      </div>
                      {isJoined && (
                        <span className="text-xs flex gap-2 items-center justify-center text-emerald-400">
                  ...
                  <div className="px-5 pb-5">
                    {isCoord ? (
                      ...
                      <button
                        ...
                        onClick={() =>
                          updateCommunity(email, item.categoryname)
                        }
                        type="button"
                        ...
                        disabled={loadingDomains.has(item.categoryname)}
                        style={
                          isJoined
                            ? {
                                background: `${accent.from}12`,
