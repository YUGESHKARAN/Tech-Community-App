...
//   }
  ...
  return (
     <div className="relative max-w-[1800px] theme mx-auto min-h-screen">

    
      {/* Search */}
      <div className="w-11/12 mx-auto max-w-md  flex items-center gap-2 justify-center mb-4 md:mb-8">
        <div className="w-full flex items-center mt-7 md:mt-4  gap-3 theme-fields-lite border border-gray-700 rounded-xl px-4 py-2 shadow-md focus-within:ring-1 focus-within:ring-teal-500/40 transition">
